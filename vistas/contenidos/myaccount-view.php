	...
	<div class="panel panel-success">
		...
		<div class="panel-body">
			<form action="<?php echo SERVERURL; ?>ajax/cuentaAjax.php" method="POST" data-form="update" class="FormularioAjax" autocomplete="off" enctype="multipart/form-data">
				...
				<?php
					if($_SESSION['codigo_cuenta_dsa'] != $campos['CuentaCodigo']){
						if($_SESSION['tipo_dsa'] != "Administrador" || $_SESSION['privilegio_dsa'] < 1 || $_SESSION['privilegio_dsa'] >2){
				...
				?>
				<input type="hidden" name="CodigoCuente-up" value="<?php echo $datos[2]; ?>">
		    	...
		    	<fieldset>
		    		...
		    		<div class="container-fluid">
		    			<div class="row">
							...
							<?php if($_SESSION['tipo_dsa'] == "Administrador" && $_SESSION['privilegio_dsa'] == 1 && $campos['id'] != 1){?>
							<div class="col-xs-12 col-sm-6">
								<div class="form-group">
		    	...
		    	<br>
				<?php if($_SESSION['tipo_dsa'] == "Administrador" && $_SESSION['privilegio_dsa'] == 1 && $campos['id'] != 1 && $campos['CuantaTipo'] == "Administrador" && $datos[1] == "admin"){?>
		    	<fieldset>
