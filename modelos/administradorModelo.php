<?php
	...
	class administradorModelo extends mainModel{
		...
		protected function desactivar_administrador_modelo($estado,$codigo){
			$query=mainModel::conectar()->prepare("UPDATE admin SET AdminEstado=:Estado WHERE CuentaCodigo=:Codigo");
			$query->bindParam(":Codigo",$codigo);
